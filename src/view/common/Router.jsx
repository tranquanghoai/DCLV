...
const notFoundPage = () => <MessagePage message='Page not found!' />,
    ...
    introductionPage = Loadable({ loading: Loading, loader: () => import('../home/IntroductionPage.jsx') }),
    propertyPage = Loadable({ loading: Loading, loader: () => import('../home/PropertyPage.jsx') }),
    agentPage = Loadable({ loading: Loading, loader: () => import('../home/StudentPage.jsx') }),
    galleryPage = Loadable({ loading: Loading, loader: () => import('../home/Gallery.jsx') }),
...
const routes = [
    ...
    { view: 'user', path: '/introduction', component: introductionPage, menuIndex: 1 },
